...
function deleteItem(id) { if (confirm("Delete this record?")) { items = items.filter(x => x.id !== id); data.expenses = items; SM.save(data); render(); SM.toast("Deleted successfully") } }
render();
